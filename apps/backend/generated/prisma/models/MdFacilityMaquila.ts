...
// @ts-nocheck 
/*
 * This file exports the `MdFacilityMaquila` model and its related types.
 *
...
export type GetMdFacilityMaquilaAggregateType<T extends MdFacilityMaquilaAggregateArgs> = {
      [P in keyof T & keyof AggregateMdFacilityMaquila]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMdFacilityMaquila[P]>
    : Prisma.GetScalarType<T[P], AggregateMdFacilityMaquila[P]>
}
...
export type GetMdFacilityMaquilaGroupByPayload<T extends MdFacilityMaquilaGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MdFacilityMaquilaGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MdFacilityMaquilaGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MdFacilityMaquilaGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MdFacilityMaquilaGroupByOutputType[P]>
      }
    >
  >
...
export type MdFacilityMaquilaCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MdFacilityMaquilaFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MdFacilityMaquilaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MdFacilityMaquila'], meta: { name: 'MdFacilityMaquila' } }
  /**
   ...
   * })
  **/
  count<T extends MdFacilityMaquilaCountArgs>(
    args?: Prisma.Subset<T, MdFacilityMaquilaCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MdFacilityMaquilaCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MdFacilityMaquilaGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MdFacilityMaquilaGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMdFacilityMaquilaGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
