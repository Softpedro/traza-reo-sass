...
// @ts-nocheck 
/*
 * This file exports the `MdUserReo` model and its related types.
 *
...
export type GetMdUserReoAggregateType<T extends MdUserReoAggregateArgs> = {
      [P in keyof T & keyof AggregateMdUserReo]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMdUserReo[P]>
    : Prisma.GetScalarType<T[P], AggregateMdUserReo[P]>
}
...
type GetMdUserReoGroupByPayload<T extends MdUserReoGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MdUserReoGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MdUserReoGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MdUserReoGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MdUserReoGroupByOutputType[P]>
      }
    >
  >
...
export type MdUserReoCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MdUserReoFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MdUserReoDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MdUserReo'], meta: { name: 'MdUserReo' } }
  /**
   ...
   * })
  **/
  count<T extends MdUserReoCountArgs>(
    args?: Prisma.Subset<T, MdUserReoCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MdUserReoCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MdUserReoGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MdUserReoGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMdUserReoGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
