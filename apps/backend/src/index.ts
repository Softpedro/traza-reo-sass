...
import { CarbonFootprintService } from "./services/carbon-footprint.service.js";
import { carbonFootprintRoutes } from "./routes/carbon-footprint.routes.js";
import { WaterFootprintService } from "./services/water-footprint.service.js";
import { waterFootprintRoutes } from "./routes/water-footprint.routes.js";
import { RestrictedSubstancesService } from "./services/restricted-substances.service.js";
import { restrictedSubstancesRoutes } from "./routes/restricted-substances.routes.js";
import { CircularEconomyService } from "./services/circular-economy.service.js";
...
import { DppPassportService } from "./services/dpp-passport.service.js";
...
const careService = new CareService(prisma);
const carbonFootprintService = new CarbonFootprintService(prisma);
const waterFootprintService = new WaterFootprintService(prisma);
...
const dppPassportService = new DppPassportService(prisma);
...
app.use("/api/dpp", dppRoutes(unitTraceService, prisma, dppPassportService));
...
app.use("/api/models", modelRoutes(modelService));
app.use("/api/cares", careRoutes(careService));
app.use("/api/carbon-footprints", carbonFootprintRoutes(carbonFootprintService));
app.use("/api/water-footprints", waterFootprintRoutes(waterFootprintService));
