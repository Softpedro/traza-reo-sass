...
/** Opciones del select de Trazabilidad (estado) en el modal de Actualizar. */
export const TRAZABILIDAD_STATUS_OPTIONS: { value: number; label: string }[] = [
...
/** Etapa fija del módulo Trazabilidad. */
export const STAGE_TRAZABILIDAD = 5;
